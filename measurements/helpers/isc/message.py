...
class Message:
    def function_probe_request(self, spoke_id, function):
        ...
        message['requested_functionality'] = function # str
    ...
    def app_response(self, spoke_id, functionality_response):
        ...
        message['spoke_id'] = spoke_id
        message['functionality_response'] = functionality_response
        serialized_msg = json.dumps(message).encode('utf-8')
        return serialized_msg
    ...
    def no_functionality_response(self, functionality_request):
        message = dict()
    ...
    def functionality_denial_response(self, functionality_request):
        message = dict()
