...
import time
from langchain.chains.time_recorder import secgpt_record
...
class Chain(RunnableSerializable[Dict[str, Any], Dict[str, Any]], ABC):
    ...
    def prep_outputs(
        ...
        if self.memory is not None:
            ...
            secgpt_record(spoke_memory_time = memory_save_time)
    ...
    def prep_inputs(self, inputs: Union[Dict[str, Any], Any]) -> Dict[str, str]:
        ...
        if self.memory is not None:
            ...
            secgpt_record(spoke_memory_time=memory_load_time)
