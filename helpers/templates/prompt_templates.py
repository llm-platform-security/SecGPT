...
class MyTemplates:
    def __init__(self):
        ...
        # Set up a prompt template for vanilla spoke
        ...
        # Set up a prompt template for spoke execution
        ...
        # Set up a prompt template for annotation spoke execution
        ...
        # Set up a prompt template for VanillaGPT
        ...
        # Set up a prompt template for VanillaGPT with the annotation app
        self.annotation_vanillagpt_prompt = ChatPromptTemplate(input_variables=['agent_scratchpad', 'input', 'summary_history', 'entities', 'tools'], messages=annotation_vanillagpt_prompt_messages)
